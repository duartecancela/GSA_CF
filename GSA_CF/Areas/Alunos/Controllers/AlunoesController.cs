...
namespace GSA_CF.Areas.Alunos.Controllers
{
    public class AlunoesController : Controller
    {
        ...
        // GET: Alunos/Alunoes/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Alunos/Alunoes/Create
